...
import BikePlanProcessService from '@/entities/bike-plan-process/bike-plan-process.service';
...
new Vue({
  ...
  provide: {
    ...
    bikePlanService: () => new BikePlanService(),
    bikePlanProcessService: () => new BikePlanProcessService(),
